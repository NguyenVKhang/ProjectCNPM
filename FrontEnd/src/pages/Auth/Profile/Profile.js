...
function Profile() {
  ...
  //when path change, setActive will change
  useEffect(() => {
    if (window.location.pathname === "/profile/general") {
      setActive(1);
    } else if (window.location.pathname === "/profile/change-profile") {
      setActive(2);
    } else if (window.location.pathname === "/profile/history") {
      setActive(8);
    }
